            ...
            <div class="container">
                <div class="card">
                    <div class="card-body"> 
                        ...
                        <button class="delete_here btn btn-primary" id="delete_here" type="button" data-poid="{{$post->id}}" data-comid="{{$comment->id}}">Delete</button><a class="btn btn-primary" href="/ec/{{$comment->id}}" > edit</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <p><a href="/api/article/detail/post/{{$post->id}}/comment/{{$comment->id}}/detail">{{$comment->des}}</a></p>
                                <p>
                                    <form action="/api/article/detail/post/{{$post->id}}/comment/{{$comment->id}}/reply" class="my_reply_form" id="my_reply_form"  method="post">
                                        @csrf
                                        <div class="panel-google-plus-comment">
...
<div class="card card-inner">
    <div class="card-body">
     ...
     <button class="delete_reply btn btn-primary" id="delete_reply" type="button" data-poid="{{$post->id}}" data-comid="{{$commentr->id}}">Delete</button><a class="btn btn-primary" href="/ec/{{$commentr->id}}" > edit</a>
     <script type="text/javascript">
        ...
        console.log(comid);
        var post_url ='/api/article/detail/post/'+poid+'/comment/'+comid+'/deletereply';
        console.log(post_url);
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('.delete_here').on('click', function (e) {
        ...
        var comid = $(this).data('comid');
        console.log(comid);
        var post_url ='/api/article/detail/post/'+poid+'/comment/'+comid+'/delete';
        console.log(post_url);
        // var id = $(this).attr('data-id');
